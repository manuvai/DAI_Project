...
<form action="ValidationCommandeServlet" method="post">
        ...
        <div>
                    <h3>Choississez les articles</h3>
                    <table>
            <tr>
                <th>Article</th>
                <th>Prix</th>
            ...
            <tr>
                ...
                <td>
                    <input type="number" name="quantite_<%= article.getId() %>" min="0" value="0">
                </td>
            </tr>
            <% 
                    }
        ...
        <button id="submit-button" class="btn-rayon" type="submit" >Commander </button>
    </form>
</body>
</html>