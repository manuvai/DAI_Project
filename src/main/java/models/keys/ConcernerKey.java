...
public class ConcernerKey implements Serializable {
	 ...
	 */
    public ConcernerKey(final int idPostIt, final int idListeDeCourse) {
     ...
     * @param idPostIt
     */
    public void setIdPostIt(final int idPostIt) {
     ...
     * @param idListeDeCourse
     */
    public void setIdListeDeCourse(final int idListeDeCourse) {
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof ConcernerKey)) {
			return false;
		}
        final ConcernerKey that = (ConcernerKey) o;
