...
/**
 * Servlet implementation class DetailsCommandeClientServlet
 */
@WebServlet("/DetailsCommandeClientServlet")
public class DetailsCommandeClientServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public DetailsCommandeClientServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		rd = request.getRequestDispatcher("detailsCommandeClient");
