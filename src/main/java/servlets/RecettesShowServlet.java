 ...
 */
@WebServlet("/RecettesServlet/show")
public class RecettesShowServlet extends AbstractServlet {
	...
	protected void responseGet(final HttpServletRequest request, final HttpServletResponse response)
		...
		if (idListe == null) {
			...
			response.sendRedirect(request.getContextPath() + "/RecettesServlet");
			return;
		}
		...
		view("recettes/show", request, response);
